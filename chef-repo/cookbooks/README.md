This directory contains the cookbooks used to configure systems in your infrastructure with Chef - we start with ourBase and ourMetrics
...
cookbook_email     "cookbooks@fastrobot.com"
